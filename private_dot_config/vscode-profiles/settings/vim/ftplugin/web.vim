...
nnoremap <Leader>ll <Cmd>call VSCodeNotify("eslint.executeAutofix")<CR>

"  nnoremap <Leader>ls <Cmd>call VSCodeExtensionNotify('open-file', '~/workspace/test.txt' )<CR>
"  nnoremap <Leader>lt <Cmd>call VSCodeExtensionNotify("open-file", "~/workspace/test.txt" )<CR>
